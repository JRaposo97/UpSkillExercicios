...
public class Data implements Comparable<Data> {
    ...
    public final void setData(int ano, int mes, int dia) throws MesInvalidoException, DiaInvalidoException {
        ...
        if (mes < 1 || mes > 12) {
            throw new MesInvalidoException("Insira um mes valido (1-12)");
        }

        if (dia < 1 || dia > Mes.obterMes(mes).numeroDeDias) {
            throw new DiaInvalidoException("Insira um dia valido (1-" + Mes.obterMes(mes).numeroDeDias + ")");
        }
        this.ano = ano;
